...
A playbook is a saved procedure the agent can run: a short Markdown file with a
...
an **End-of-run report**, and a **Done when** check. The answer to a recurring
request can *be* a playbook — write it down once, run it many times.
